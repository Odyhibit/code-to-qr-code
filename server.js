...
function startHTTPS() {
  ...
  https.createServer(options, handler).listen(PORT, function() {
    ...
    console.log('');
    console.log('  Encoder: https://localhost:' + PORT + '/encoder/');
    console.log('  Decoder: https://localhost:' + PORT + '/decoder/');
  });
}
...
function startHTTP() {
  http.createServer(handler).listen(PORT, function() {
    ...
    console.log('');
    console.log('NOTE: Camera requires HTTPS and will NOT work on phone over HTTP.');
    console.log('Encoder: http://localhost:' + PORT + '/encoder/');
    console.log('Decoder: http://localhost:' + PORT + '/decoder/');
  });
}
